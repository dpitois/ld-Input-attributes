// import { LdInput, LdLabel } from "@emdgroup-liquid/liquid/dist/react-define-excluded"
// import { LdInput, LdLabel } from "@emdgroup-liquid/liquid/dist/react-define-excluded"
...
function App() {
  return (
    <>
      ...
      <div>
        <LdLabel position="right">
          <LdInput disabled={true} readonly={true} /> disabled with boolean + readonly with boolean
        </LdLabel>
      </div>
      <LdTypo>Not editable (as expected)</LdTypo>
      <div>
        <LdLabel position="right">
          <LdInput disabled={true} readonly="true" /> disabled with boolean + readonly as string
        </LdLabel>
      </div>
      <div>
        <LdLabel position="right">
